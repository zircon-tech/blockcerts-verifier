    ...
    $.fn.filterizr.prototype = {
        ...
        */
        init: function(selector, options) {
            ...
            //Highest value in data-category of .filtr-items
    ...
    var FiltrItemProto = {
        ...
        */
        _init: function(index, parent) {
            ...
            self._parent = parent;
            //Ref to parent Filterizr object
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    var popup = {
        ...
        //a hardcoded value. equals the CSS transition-duration.
        DOM: {
            $popups: $('.popup'),
